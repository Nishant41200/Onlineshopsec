...
<body>
    ...
    $stmt->close();
                    ...
                    $result = $conn->query("SELECT productID, productName, productPrice, Quantity, productPrice*quantity as cost, productPhoto FROM product NATURAL JOIN cart WHERE personId=? AND deliveryID=0");
                    $result->bind_param("i", $personID[0]);
